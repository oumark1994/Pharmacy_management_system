        ...
        <div class="row">
            ...
            <div class="card w-100">
              <div class="card-body p-4">
                <h5 class="card-title fw-semibold mb-4 text-center">All the sales</h5>
                  ...
                  <tbody>
                    @foreach ($sales as $sale)
                        <tr>
                          ...
                          <td>
                          <button class="btn btn-outline-primary" onclick="window.location='{{url('/editsale/'.$sale->id)}}'">Edit</button>
                          <a class="btn btn-outline-danger" id="delete" href="{{url('/deletesale/'.$sale->id)}}">Delete</a>
